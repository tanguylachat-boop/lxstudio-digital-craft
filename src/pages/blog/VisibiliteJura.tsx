...
const VisibiliteJura = () => {
  ...
  return (
    <div className="min-h-screen pt-20 bg-background">
      <Helmet>
        <title>SEO Jura – Comment booster votre visibilité locale | LX Studio</title>
        <meta name="description" content="Découvrez les meilleures stratégies pour améliorer le référencement local de votre entreprise dans le Jura avec LX Studio." />
        <meta property="og:title" content="SEO Jura – Comment booster votre visibilité locale" />
        <meta property="og:description" content="Découvrez les meilleures stratégies pour améliorer le référencement local de votre entreprise dans le Jura avec LX Studio." />
