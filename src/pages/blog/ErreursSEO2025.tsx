...
const ErreursSEO2025 = () => {
  ...
  return (
    <div className="min-h-screen pt-20 bg-background">
      <Helmet>
        <title>5 erreurs SEO à éviter en 2025 – LX Studio Suisse</title>
        <meta name="description" content="Découvrez les erreurs SEO les plus courantes et comment les éviter pour améliorer votre référencement en Suisse." />
        <meta property="og:title" content="5 erreurs SEO à éviter en 2025 – LX Studio Suisse" />
        <meta property="og:description" content="Découvrez les erreurs SEO les plus courantes et comment les éviter pour améliorer votre référencement en Suisse." />
