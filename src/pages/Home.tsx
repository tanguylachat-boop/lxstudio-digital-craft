...
const Home = () => (
  <div className="min-h-screen">
    <Helmet>
      <title>LX Studio — Agents IA & Infrastructure digitale pour PME suisses</title>
      <meta
        name="description"
        content="L'agence IA n°1 pour les PME suisses. Agents IA, automatisations et dashboards sur mesure. Résultats en 5 jours. Dès 490 CHF."
      />
      <meta property="og:title" content="LX Studio — Agents IA pour PME suisses" />
      <meta
        property="og:description"
        content="Automatisez votre business avec des agents IA sur mesure. Email, facturation, chatbot, réseaux sociaux — résultats en 5 jours."
      />
