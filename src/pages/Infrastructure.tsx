...
const InfrastructurePage = () => (
  <div className="min-h-screen">
    <Helmet>
      <title>Dashboard IA sur mesure pour PME | LX Studio</title>
      <meta
        name="description"
        content="Infrastructure digitale complète pour PME suisses. Dashboard IA, workflows automatisés, rapports en temps réel. Dès 5'000 CHF."
      />
    </Helmet>
