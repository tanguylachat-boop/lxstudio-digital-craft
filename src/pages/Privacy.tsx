...
const Privacy = () => {
  return (
    <>
      <Helmet>
        <title>Politique de Confidentialité — LX Studio</title>
        <meta
          name="description"
          content="Politique de confidentialité de LX Studio. Protection des données personnelles et sécurité."
        />
        <link rel="canonical" href="https://www.lxstudio.ch/privacy" />
